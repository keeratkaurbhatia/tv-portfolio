  ...
  return {
    ...
    plugins: [
      ...
      cloudflare({
        ...
        // The portfolio preview does not need a Worker debugger. Disabling it
        // also lets the dev server run in restricted environments where the
        // default inspector port cannot be opened.
        inspectorPort: false,
      }),
    ],
  };
